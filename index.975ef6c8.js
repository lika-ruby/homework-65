...
const findCurrentKey = (index)=>{
    if (index > 11 || !isPlaying) {
        ...
        name.textContent = `\u{41D}\u{435}\u{43C}\u{430}`;
        number.textContent = `\u{41D}\u{456}\u{44F}\u{43A}\u{430}`;
    } else {
        number.textContent = index + 1;
        name.textContent = `${(0, _keys.keys)[index].name}`;
    }
};
document.addEventListener("keydown", (e)=>{
    e.preventDefault();
    if (!isPlaying) return;
    if (e.code === (0, _keys.keys)[currentKeyIndex].code) {
        currentKeyIndex += 1;
...
},{"./js/keys":"gbR2W","chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@pnotify/core":"9RSjy"}],"gbR2W":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9RSjy":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
